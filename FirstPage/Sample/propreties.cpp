    ...
    : QWidget(parent)
{
    ...
    QLabel *firstNameLabel = new QLabel("Player one info:", this);
    firstNameLabel->setStyleSheet("font-weight: bold; color: #34495e;");

    QLineEdit *first_name_line = new QLineEdit(formFrame);
    first_name_line->setPlaceholderText("Enter your name and last name");
    ...
    QLabel *lastNameLabel = new QLabel("Player two info:", this);
    lastNameLabel->setStyleSheet("font-weight: bold; color: #34495e;");

    QLineEdit *last_name_edit = new QLineEdit(this);
    last_name_edit->setPlaceholderText("Enter your name and last name");
    ...
    connect(button, &QPushButton::clicked, [=]() {
        first = first_name_line->text();
        last = last_name_edit->text();
